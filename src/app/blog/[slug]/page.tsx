...
import { urlFor } from '@/lib/sanity'; // ודא שיש לך פונקציית עזר לתמונות
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
    ...
    if (!post) {
      // ייתכן שנרצה עמוד 404 ייעודי יותר בעתיד
        return (
    ...
    return (
        <article className="py-24 sm:py-32 bg-white" dir="rtl">
            <div className="container mx-auto px-6 lg:px-8 max-w-3xl">
                ...
                {/* שימוש ב-Tailwind Prose לעיצוב טיפוגרפי עשיר */}
                ...
                <div className="mt-20 pt-16 border-t border-slate-200">
                    <LeadMagnetForm 
                        ...
                        listId="YOUR_LIST_ID" // נצטרך להגדיר את זה בהמשך
                    />
                </div>
            </div>
        </article>
