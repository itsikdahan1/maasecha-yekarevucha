// src/components/TestimonialsPreviewSection.tsx
...
export const TestimonialsPreviewSection: FC<TestimonialsPreviewProps> = ({ testimonials }) => {
  // ניקח עד 3 המלצות להצגה בעמוד הבית
  ...
  return (
    <section id="testimonials-preview" className="py-24 sm:py-32 bg-white" dir="rtl">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-1 lg:grid-cols-3">
          {testimonialsToShow.map((testimonial) => (
            <figure key={testimonial._id} className="flex flex-col justify-between p-8 bg-brand-cream/60 rounded-2xl shadow-lg border border-slate-100">
              <blockquote className="text-lg text-slate-800 before:content-['“'] before:mr-1 before:text-2xl before:text-brand-cyan after:content-['”'] after:ml-1 after:text-2xl after:text-brand-cyan">
